...
public class DeepSeekAPI : MonoBehaviour
{
    // API配置
    [Header("API Settings")]
    [SerializeField] private string apiKey = "sk-79962c4483764b359996ca5ad36ae8e0";// DeepSeek API密钥
    ...
    public class NPCCharacter
    {
        public string name;
        [TextArea(3, 10)]
        public string personalityPrompt = "你是中国古代建筑世界的管理者，你要告知探索者，这个世界面临自然灾厄的威胁，玩家的任务是帮助这个世界走上正轨，你精通中国古代建筑学知识";// 角色设定提示词
    }
